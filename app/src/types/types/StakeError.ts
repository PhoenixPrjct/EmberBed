...
export interface InvalidStakeStateJSON {
  kind: "InvalidStakeState"
}

export class InvalidStakeState {
  static readonly discriminator = 2
  static readonly kind = "InvalidStakeState"
  readonly discriminator = 2
  readonly kind = "InvalidStakeState"

  toJSON(): InvalidStakeStateJSON {
    return {
      kind: "InvalidStakeState",
    }
  }
...
export function fromDecoded(obj: any): types.StakeErrorKind {
  ...
  if ("InvalidStakeState" in obj) {
    return new InvalidStakeState()
  }

  throw new Error("Invalid enum object")
}

export function fromJSON(obj: types.StakeErrorJSON): types.StakeErrorKind {
  switch (obj.kind) {
...
export function layout(property?: string) {
  const ret = borsh.rustEnum([
    ...
    borsh.struct([], "InvalidStakeState"),
  ])
